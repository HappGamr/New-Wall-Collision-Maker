...
- This script is originally made for kill houses but it can be used for other types of buildings although you'd need to check if their extended collision parts are created correctly and all that.
